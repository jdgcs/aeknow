...
///////////////////////////////////////get mining
		...
		if($data['transaction_count']>0){
			$data['activities'].='  <small class="label pull-right bg-green">Mining</small>'; 
			}
		...
		$row = $query->row();		
		if($row->count>0){
			$data['activities']=' <small class="label pull-right bg-yellow">Genesis</small>'.$data['activities']; 
			}
