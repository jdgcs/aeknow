...
///////////////////////////////////////get mining
		...
		foreach ($query->result() as $row){
			$data['activities']=' <small class="label pull-right bg-blue">Mining</small>'; 
			$counter++;
		...
		$row = $query->row();		
		if($row->count>0){
			$data['activities'].=' <small class="label pull-right bg-yellow" style="padding-right:10px;">Genesis</small>'; 
			}
